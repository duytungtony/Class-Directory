...
contract Coinflip is Ownable{
    ...
    constructor() Ownable(msg.sender) {
        // TODO: Set the initial seed value
    ...
    function userInput(uint8[10] calldata Guesses) external view returns(bool){
        // TODO: Get the contract generated flips
        uint8[10] memory flips = getFlips();

        // TODO: Compare each element of the user's guesses with the generated guesses
        for (uint8 i = 0; i < 10; i++) {
            if (Guesses[i] != flips[i]) {
                return false; // Nếu một dự đoán sai → Người chơi thua
            }
        }
        return true; // Nếu tất cả đúng → Người chơi thắng
    }
    ...
    function seedRotation(string memory NewSeed) public onlyOwner {
        // TODO: Cast the string into a bytes array
